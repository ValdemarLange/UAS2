...
class FilterWithEssentialMatrix:
    ...
    def set_camera_matrix(self):
        ...
        self.dist_coef = np.array([0, 0, 0, 0])
    ...
    def determine_essential_matrix_and_filter_points(self):
        ...
        self.match_indices = self.match_indices[self.essential_mask.ravel() == 1]
    ...
    def draw_filtered_matches(self):
        ...
        cv2.imwrite(
            "../output/ex04_matching_features_filtered_essental_matrix.png", img3
        )
