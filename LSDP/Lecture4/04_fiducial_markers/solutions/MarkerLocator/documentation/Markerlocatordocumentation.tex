...
\begin{figure}
\centering
\subfloat[Real part of kernel.]{\includegraphics[width=4cm]{pythonpic/kernel_real_part.png}
\label{figRealPartOfN4Kernel}}
\hspace{.05\textwidth}%
\subfloat[Imaginary part of kernel.]{\includegraphics[width=4cm]{pythonpic/kernel_imaginary_part.png}
\label{figImagPartOfN4Kernel}}
\hspace{.05\textwidth}%
\subfloat[Magnitude of kernel.]{\includegraphics[width=4cm]{pythonpic/kernel_magnitude.png}
\label{figMagnitudeOfN4Kernel}}
\hspace{.05\textwidth}%
\subfloat[Argument of kernel.]{\includegraphics[width=4cm]{pythonpic/kernel_argument.png}
...
\begin{figure}
\centering
\subfloat[Input image containing markers of order 4 and 5.]{\includegraphics[width=5cm]{pythonpic/hubsanwithmarker_small.png}
\label{figHubsanInputImage}}
\hfill%
\subfloat[Marker detection response in inverted colors. Black denotes a high response to the marker.]{\includegraphics[width=5cm]{pythonpic/hubsan_magnitude_response_inverted_n4_kernel.png}
